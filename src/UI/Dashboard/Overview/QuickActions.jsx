...
export const QuickActions = ({ className }) => {
  return (
    <section
      className={`flex flex-col px-2 sm:px-4 grow shadow-lg rounded-xl p-4 sm:pb-4 gap-4 sm:gap-5 ${className}`}
    >
      <header className='font-semibold text-lg px-2'>Quick Actions</header>
      <section className='flex flex-col sm:flex-row justify-between gap-4 sm:gap-5 md:gap-7 px-2'>
