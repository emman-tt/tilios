...
export const Body = ({ searchValue }) => {
  ...
  return (
    <section
      ...
      className='w-full h-full relative overflow-x-auto [scrollbar-width:thin] shadow-lg  p-5 max-sm:p-2 pt-2 rounded-2xl'
    >
      <div className=''>
        <header className='min-w-250 w-full items-center text-sm py-2 font-semibold rounded-xl grid grid-cols-8 bg-[#eef0f2]'>
          {headerList.map(item => (
        ...
        {confirmModal.status && (
          <div className='fixed inset-0 backdrop-blur-sm bg-[#1a191948] z-8'></div>
        )}
